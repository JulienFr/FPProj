...
action_5 (8) = happyShift action_13
action_5 _ = happyFail

action_6 (8) = happyShift action_12
...
action_20 (5) = happyGoto action_10
...
action_21 (5) = happyGoto action_10
...
happyReduction_7 ((HappyAbsSyn4  happy_var_4) `HappyStk`
        ...
        happyRest)
         = HappyAbsSyn5
                 (Abstract happy_var_2 happy_var_4
        ) `HappyStk` happyRest
...
lambda tks = happyRunIdentity happySomeParser where
...
parse = getContents >>= (print . lambda . lexer)
